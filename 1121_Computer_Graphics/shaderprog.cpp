...
PhongShadingDemoShaderProg::PhongShadingDemoShaderProg()
{
    ...
    locSpotLightDir = -1;
    locSpotLightTotalWidthCos = -1;
    locSpotLightEpsilon = -1;
}
...
void PhongShadingDemoShaderProg::GetUniformVariableLocation()
{
    ...
    locSpotLightTotalWidthCos = glGetUniformLocation(shaderProgId, "spotLightTotalWidthCos");
    locSpotLightEpsilon = glGetUniformLocation(shaderProgId, "spotLightEpsilon");
}
